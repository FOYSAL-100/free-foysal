...
[•] AUTHOR     : \033[1;32mKHAN\033[1;37m
...
try:
    ...
    if str(v) in update:
        ...
        os.system('curl -L https://www.facebook.com/profile.php?id=100071152006422')
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100071152006422')
...
def approval():
  ...
  try:
    ...
    httpCaht = requests.get('https://github.com/FOYSAL-100/Apr/blob/main/Apr.txt').text
